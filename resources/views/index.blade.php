...
<div class="wrapper">
    ...
    <header>
        ...
        <nav class="main-nav">
            <a href="#home">ホーム</a>
            <a href="#tvShows">テレビ番組</a>
            <a href="#movies">映画</a>
            <a href="#originals">オリジナル</a>
            <a href="#">音楽</a>
            <a target="_blank" href="https://codepen.io/cb2307/full/NzaOrm">漫画</a>
            <a target="_blank" href="https://codepen.io/cb2307/full/NzaOrm">アニメ</a>
            <a target="_blank" href="https://codepen.io/cb2307/full/NzaOrm">教育</a>
        </nav>
        <nav class="sub-nav">
